...
class FilmDAOImplTest {
    ...
    void findById() {
        tools.createFilm1();
        Optional<Film> filmOptional = filmDAOImpl.findById(1);
    ...
    void findAll() {
        tools.createFilm1();
        List<Film> films = filmDAOImpl.findAll();
    ...
    void update() {
        tools.createFilm1();
        Film updatedFilm = filmDAOImpl.findById(1).orElseThrow();
        updatedFilm.setName("new name");
        updatedFilm.setDuration(30);

        filmDAOImpl.update(updatedFilm);
